...
extern "C" void app_main(void)
{
	...
	int ret = 0;
	ret = usb_ptp_transfer(PTP_OC_OpenSession,          1, 1,  0,0,0,0, NULL,0, NULL,NULL);
	ret = usb_ptp_transfer(PTP_OC_SDIOConnect,          3, 1,  0,0,0,0, NULL,0, NULL,NULL);
	ret = usb_ptp_transfer(PTP_OC_SDIOConnect,          3, 2,  0,0,0,0, NULL,0, NULL,NULL);
	ret = usb_ptp_transfer(PTP_OC_SDIOGetExtDeviceInfo, 1, 300,0,0,0,0, NULL,0, NULL,NULL);
	ret = usb_ptp_transfer(PTP_OC_SDIOConnect,          3, 3,  0,0,0,0, NULL,0, NULL,NULL);
